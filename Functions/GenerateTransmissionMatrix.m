function [Tout]=GenerateTransmissionMatrix(filename,Centx,Centy,CircFilt,FilterHolo)
...
Fpupx=linspace(-NA/lambda,NA/lambda,length(SPX));
Fpupy=linspace(-NA/lambda,NA/lambda,length(SPY));
